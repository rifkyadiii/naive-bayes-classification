Berikut adalah isi file README yang bisa kamu gunakan untuk menjelaskan tahapan dan langkah-langkah pada proyek klasifikasi menggunakan Naive Bayes dengan dataset `dataset_buys_comp.csv`:
